...
with tab3:
    ...
    upside_map = {"SBI Gold Fund (+17.1% upside)": 17.1, "HDFC Gold ETF (+15.6% upside)": 15.6, "ICICI Prudential Tech (+15.4% upside)": 15.4, "SBI Technology (+13.2% upside)": 13.2, "Infosys (INFY) (+48.3% upside)": 48.3, "TCS (+41.7% upside)": 41.7, "HDFC Bank (+38.4% upside)": 38.4, "Reliance Industries (+23.4% upside)": 23.4}
    ...
    m4.metric("Estimated Horizon", "3 - 8 Weeks", "Historical Cycle")            pass
